...
if (typeof NEXLAYER_API_KEY === 'undefined') {
  global.NEXLAYER_API_KEY = 'example_api_key_12345';
}

if (typeof NEXT_PUBLIC_NEXLAYER_API_KEY === 'undefined') {
  global.NEXT_PUBLIC_NEXLAYER_API_KEY = 'example_api_key_12345';
}
...
if (typeof process !== 'undefined' && process.env) {
  ...
  process.env.NEXLAYER_API_KEY = process.env.NEXLAYER_API_KEY || 'example_api_key_12345';
  process.env.NEXT_PUBLIC_NEXLAYER_API_KEY = process.env.NEXT_PUBLIC_NEXLAYER_API_KEY || 'example_api_key_12345';
}

module.exports = {
  DATABASE_URL: global.DATABASE_URL,
  API_KEY: global.API_KEY,
  NEXLAYER_API_KEY: global.NEXLAYER_API_KEY,
  NEXT_PUBLIC_NEXLAYER_API_KEY: global.NEXT_PUBLIC_NEXLAYER_API_KEY
};
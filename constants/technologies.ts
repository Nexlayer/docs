...
export const technologies: Record<string, Technology> = {
  ...
  huggingface: {
    ...
    category: "ai",
    image: "https://api-inference.huggingface.co",
    servicePorts: [443],
    vars: {
      HF_TOKEN: "<% SECRET_HF_TOKEN %>",
      HF_API_URL: "https://api-inference.huggingface.co",
    },
    description: "Hugging Face Transformers API integration",
    comment: "# 🤖 Hugging Face Transformers API integration — external API service",
  },
  openai: {
    id: "openai",
    name: "openai api",
    ...
    comment: "# 🤖 OpenAI API integration — external API service",
  },
  langchain: {
    id: "langchain",
    name: "langchain",
  ...
  claude: {
    ...
    name: "claude",
    category: "ai",
    image: "https://api.anthropic.com/v1",
    servicePorts: [443],
    vars: {
    ...
    comment: "# 🤖 Claude AI model integration — external API service",
  },

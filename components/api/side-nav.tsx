                  ...
                  >
                    <ul className="space-y-1 mt-1 ml-2">
                      {endpoints.map((endpoint) => {
                        ...
                        const slug = hasPathParams ? null : getEndpointSlug(endpoint)
                        const isActive = slug ? pathname === `/api-reference/${slug}` : false

                        return (
                          <li key={`${endpoint.method}-${endpoint.path}`}>
                            {hasPathParams ? (
                              // For endpoints with path parameters, show as disabled
                              <div className="flex items-center py-2 px-3 rounded-lg text-sm text-zinc-600 cursor-not-allowed">
                                <span
                                  className={cn(
                              ...
                              // For endpoints without path parameters, create links

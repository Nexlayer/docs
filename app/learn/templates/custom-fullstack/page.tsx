        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 relative z-10'>
          ...
          <div className='max-w-4xl mx-auto mb-12'>
            <div className='bg-[#0a0a0a] rounded-xl p-8 border border-[#333]'>
              ...
              <p className='text-gray-300 mb-6'>
                Custom Fullstack is a comprehensive application template that
                includes a Next.js frontend, custom backend API, Cloudbeaver for
                database management, Redis for caching, PostgreSQL for data
                storage, and Prometheus for monitoring. Perfect for building
                enterprise-grade applications with full observability and
              ...
              <div className='grid md:grid-cols-2 gap-6'>
                ...
                <div className='bg-[#111] rounded-lg p-4 border border-[#333]'>
                  ...
                  <ul className='text-gray-400 text-sm space-y-2'>
                    <li>
                      • <span className='text-[#22B4C8]'>Frontend:</span>{' '}
                      Next.js + TypeScript
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Backend:</span> Custom
                      API
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Database:</span>{' '}
                      PostgreSQL
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Cache:</span> Redis
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>DB Management:</span>{' '}
                      Cloudbeaver
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Monitoring:</span>{' '}
                      Prometheus
                    </li>
                  </ul>
                </div>
          ...
          <div className='max-w-4xl mx-auto mb-12'>
            ...
            <div className='grid lg:grid-cols-2 gap-6 mb-8'>
              <div className='bg-[#0a0a0a] flex flex-col justify-between rounded-xl p-6 border border-[#333]'>
                <div>
                  <h3 className='text-xl font-bold text-white mb-4'>
                    Via Playground
                  </h3>
                  <p className='text-gray-300 mb-4'>
                    Use the Nexlayer Playground for a visual deployment
              ...
              <div className='bg-[#0a0a0a] rounded-xl p-6 border border-[#333]'>
                ...
                <p className='text-gray-300 mb-4'>
                  Deploy directly using the command line for automated
                  workflows.
                </p>
                <div className='bg-[#111] rounded-lg p-4 border border-[#333]'>
            ...
            <div className='bg-[#0a0a0a] rounded-xl p-6 border border-[#333]'>
              ...
              <p className='text-gray-300 mb-4'>
                ...
                <code className='bg-[#111] px-2 py-1 rounded text-sm'>
          ...
          <div className='text-center'>
            <div className='bg-[#0a0a0a] rounded-xl p-10 border border-[#333] max-w-2xl mx-auto'>
              ...
              <p className='text-gray-300 mb-8'>
                Get your enterprise-grade fullstack application running in

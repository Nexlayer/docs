          ...
          <div className='max-w-4xl mx-auto mb-12'>
            <div className='bg-[#0a0a0a] rounded-xl p-8 border border-[#333]'>
              ...
              <p className='text-gray-300 mb-6'>
                Hello World NextJS is a simple, production-ready NextJS
                application that demonstrates basic deployment patterns. Perfect
                for getting started with NextJS applications on Nexlayer.
              </p>
              ...
              <div className='grid md:grid-cols-2 gap-6'>
                ...
                <div className='bg-[#111] rounded-lg p-4 border border-[#333]'>
                  ...
                  <ul className='text-gray-400 text-sm space-y-2'>
                    <li>
                      • <span className='text-[#22B4C8]'>Framework:</span>{' '}
                      NextJS
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Language:</span>{' '}
                      TypeScript
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Web Server:</span>{' '}
                      Nginx
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Container:</span>{' '}
                      Docker
                    </li>
                    <li>
                      • <span className='text-[#22B4C8]'>Registry:</span> GitHub
                      Container Registry
                    </li>
                  </ul>
                </div>
          ...
          <div className='text-center'>
            <div className='bg-[#0a0a0a] rounded-xl p-10 border border-[#333] max-w-2xl mx-auto'>
              ...
              <p className='text-gray-300 mb-8'>
                Get your NextJS application running in minutes with this
                template.
              </p>
